...
**✨ Draft** — ระบบจะร่างทุกช่องให้ครบ ทั้ง prompt, ความเชี่ยวชาญ, บุคลิก, กฎ
...
⚙ → SKILLS: เขียนขั้นตอนการทำงานที่ใช้ซ้ำได้ (เช่น "วิธี deploy เว็บของบริษัท")
แล้ว assign ให้ agent คนไหนก็ได้ — มันจะติดไปกับทุก session ใหม่ของเขา
