...
const I18N = {
  en: {
    ...
    f_voice_t:"Voice, channels & memory", f_voice_d:"Talk by voice (F6 push-to-talk), call the office (realtime Gemini Live), give agents one of 16 ♀/♂ voices, and run it from Telegram, Discord, LINE, Slack, WhatsApp or Messenger. Hermes-style memory grows token-lean.",
  ...
  de: {
    ...
    f_voice_t:"Sprache, Kanäle und Gedächtnis", f_voice_d:"Sprechen Sie per Sprache (F6 Push-to-Talk), rufen Sie das Büro an (Echtzeit-Gemini Live), geben Sie Agents eine von 16 · Stimmen, und betreiben Sie es über Telegram, Discord, LINE, Slack, WhatsApp oder Messenger. Das Hermes-artige Gedächtnis wächst token-sparsam.",
  ...
  th: {
    ...
    f_voice_t:"เสียง ช่องทาง และความจำ", f_voice_d:"คุยด้วยเสียง (F6 กดพูด), โทรหาออฟฟิศ (Gemini Live เรียลไทม์), ตั้งเสียงให้ agent ได้ 16 แบบ ♀/♂ และสั่งงานผ่าน Telegram, Discord, LINE, Slack, WhatsApp, Messenger ความจำสไตล์ Hermes โตแบบประหยัด token",
